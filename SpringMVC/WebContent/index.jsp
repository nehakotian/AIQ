...
<a href="example3.do">Click here</a> to run the example.<!-- it will go through dispatcher service bcoz of .do -->

<h2>Example 4</h2>
In this example we will see how the controller itself can generate the response.
This can be helpful in RESTful use cases.
<a href="controller/example4">Click here</a> to run the example. <!-- it will go through dispatcher service bcoz of /controller -->
...
<a href="controller/example10?theme=default">Theme 1</a> | <a href="controller/example10?theme=green">Delete</a>
			|<a href="controller/example10?theme=red">Theme2</a>	
