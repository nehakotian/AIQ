...
public class PersonReflection {
	public static void main(String[] args) {
		...
		Field[] fields=pc.getDeclaredFields(); //getDeclaredFields() will display all the fields even if it is private
		System.out.println("-- Fields of "+pc);
		for (Field f : fields) {
			System.out.println(f);// getFields() wont display the fields bcoz it is private
		}
